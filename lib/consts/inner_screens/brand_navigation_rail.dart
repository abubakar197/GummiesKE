                ...
                child: ConstrainedBox(
                  ...
                  child: IntrinsicHeight(
                    child: NavigationRail(
                      ...
                      destinations: [
                        buildRotatedTextRailDestination('Cookies', padding),
                        buildRotatedTextRailDestination("Ever_green", padding),
                        buildRotatedTextRailDestination("Good_karma", padding),
                        buildRotatedTextRailDestination("Nature", padding),
                        buildRotatedTextRailDestination("Gummies", padding),
                        buildRotatedTextRailDestination("Dot New", padding),
                        buildRotatedTextRailDestination(
                            "1 Third Freak", padding),
